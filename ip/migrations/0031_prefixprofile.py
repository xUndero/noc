...
class Migration(BaseMigration):
    ...
    def migrate(self):
        ...
        db.add_column("ip_prefix", "profile", DocumentReferenceField("ip.PrefixProfile", null=True, blank=True))
        ...
        for style_id in style_profiles:
            ...
            db.execute("UPDATE ip_prefix SET profile = %%s WHERE %s" % cond, [str(style_profiles[style_id])])
