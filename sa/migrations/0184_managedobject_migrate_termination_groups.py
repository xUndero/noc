    ...
    def migrate(self):
        ...
        for tg_id in tg_ids:
            self.db.execute(
                ...
                "WHERE termination_group_id = %s", [rg_map[tg_id], rg_map[tg_id], tg_id]
            )
        ...
        self.db.drop_column("sa_managedobject", "termination_group_id")
        self.db.drop_column("sa_managedobject", "service_terminator_id")
