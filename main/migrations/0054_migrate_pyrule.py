...
class Migration(BaseMigration):
    ...
    PMAP = [
        ("drop_event", "IEventTrigger"), ("get_single_result", "IReduceTask"), ("matrix_report", "IReduceTask"),
        ("mrt_result", "IReduceTask"), ("open_event", "IEvent"), ("prefix_list_provisioning",
                                                                  "IReduceTask"), ("refresh_config", "IEventTrigger"),
        ("result_report", "IReduceTask"), ("vc_provisioning", "IReduceTask"), ("version_inventory", "IReduceTask")
    ]
