    ...
    def migrate(self):
        ...
        db.create_table(
            "main_customfield", (
                ...
                ("table", models.CharField("Table", max_length=64)), ("name", models.CharField("Name", max_length=64)),
                ("is_active", models.BooleanField("Is Active", default=True)),
                ("label", models.CharField("Label", max_length=128)),
                ("type", models.CharField("Type", max_length=64, choices=[("str", "String"), ("int", "Integer")])),
